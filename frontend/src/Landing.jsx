            ...
            <div className="modal-content">
              {activeModal === 'privacy' && (
                <>
                  ...
                  <p>Welcome to ProposalWriterAI. We value your privacy and are committed to protecting your personal and business data. This Privacy Policy explains how we collect, use, and safeguard your information.</p>
                  ...
                  <p>Your uploaded documents are securely stored in Supabase. When you submit a request to generate a proposal, relevant sections of these documents are sent securely to Anthropic's Claude API to customize the text. Under our commercial agreement, Anthropic does not retain this data or use it to train public models.</p>

                  <h3>3. Data Security</h3>
                  <p>We implement Postgres Row-Level Security (RLS) policies to ensure that your documents and proposal history are fully private to your account. No other user has visibility into your assets.</p>
              ...
              {activeModal === 'terms' && (
                <>
                  ...
                  <p className="modal-date">Last updated: June 9, 2026</p>
                  <p>By registering or using the ProposalWriterAI SaaS platform, you agree to comply with and be bound by these Terms of Service.</p>
                  ...
                  <p>We offer a Free Tier (3 proposals, limited uploads) and a Pro Plan ($29/month, unlimited generation and document storage). Subscriptions auto-renew monthly until cancelled in your billing portal.</p>

                  <h3>4. Limitation of Liability</h3>
                  <p>ProposalWriterAI is provided "as is". While our grounding system ensures high-quality custom outputs, users are expected to review all proposals before sending them to clients. We are not responsible for any incorrect AI generations.</p>
                </>
              )}
              {activeModal === 'security' && (
                <>
                  ...
                  <p className="modal-date">Last updated: June 9, 2026</p>
                  <p>Security is at the core of ProposalWriterAI. We design our platform to secure your proprietary corporate knowledge bases at every layer.</p>

                  <h3>1. Row-Level Data Isolation</h3>
                  <p>We use Supabase database isolation policies. Every table in our database runs Row-Level Security (RLS) checks tied to your Supabase Auth user ID. This ensures data leak prevention: no user can query or modify another user's documents or proposals.</p>

                  <h3>2. Encryption in Transit & Rest</h3>
                  <p>All traffic between client browsers, our FastAPI backend, and Supabase database endpoints is encrypted using TLS (HTTPS). Database storage volumes and credentials are encrypted at rest.</p>

                  <h3>3. Secure LLM APIs</h3>
                  <p>FastAPI proxies all communication with Anthropic's Claude models. No API keys are exposed to the client, and all document chunks are passed securely using authenticated zero-retention developer API endpoints.</p>

                  <h3>4. Incident Response</h3>
                  <p>We perform regular dependency audits and vulnerability scans. For security vulnerability disclosures or inquiries, contact us at <a href="mailto:jesusgtech0@gmail.com">jesusgtech0@gmail.com</a>.</p>
                </>
              )}
            </div>
